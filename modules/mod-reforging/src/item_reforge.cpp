...
std::string ItemReforge::StatTypeToString(uint32 statType) const
{
    static std::unordered_map<uint32, std::string> statTypeToStrMap = {
        {ITEM_MOD_MANA, "法力"}, {ITEM_MOD_HEALTH, "生命值"}, {ITEM_MOD_AGILITY, "敏捷"},
        ...
        {ITEM_MOD_CRIT_RANGED_RATING, "远程暴击等级"}, {ITEM_MOD_CRIT_SPELL_RATING, "法术暴击等级"}, {ITEM_MOD_HIT_TAKEN_MELEE_RATING, "近战被命中等级"},
        {ITEM_MOD_HIT_TAKEN_RANGED_RATING, "远程被命中等级"}, {ITEM_MOD_HIT_TAKEN_SPELL_RATING, "法术被命中等级"}, {ITEM_MOD_CRIT_TAKEN_MELEE_RATING, "近战被暴击等级"},
        {ITEM_MOD_CRIT_TAKEN_RANGED_RATING, "远程被暴击等级"}, {ITEM_MOD_CRIT_TAKEN_SPELL_RATING, "法术被暴击等级"}, {ITEM_MOD_HASTE_MELEE_RATING, "近战急速等级"},
        {ITEM_MOD_HASTE_RANGED_RATING, "远程急速等级"}, {ITEM_MOD_HASTE_SPELL_RATING, "法术急速等级"}, {ITEM_MOD_HIT_RATING, "命中等级"},
        {ITEM_MOD_CRIT_RATING, "暴击等级"}, {ITEM_MOD_HIT_TAKEN_RATING, "被命中等级"}, {ITEM_MOD_CRIT_TAKEN_RATING, "被暴击等级"},
